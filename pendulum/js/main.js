...
function pendulum() {
  ...
  btnOn();
  function btnOn() {
    document.querySelector('.pendulum-demo__btn-start').addEventListener('click', function() {  
  ...
  btnOff()
  function btnOff() {
      document.querySelector('.pendulum-demo__btn-stop').addEventListener('click', function() {
  ...
  function showBgInput() {
    document.querySelectorAll('.pendulum-result__formula>input').forEach(input => {
      ...
      timeout3 = setTimeout(() => input.classList.remove('change'), 1500)
    })  
    document.querySelectorAll('.pendulum-result__formula-fraction>input').forEach(input => {
      input.classList.add('change')
      timeout4 = setTimeout(() => input.classList.remove('change'), 1500)
    })  
  }
